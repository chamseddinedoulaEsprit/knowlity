...
public class ListeCoursInscritsController {
    ...
    private ServiceInscription serviceInscription = new ServiceInscription();
    ...
    public void initialize() {
        ...
        // Initialiser les listes de cours inscrits
        allCourses = serviceInscription.getCoursInscrits(userId);
    ...
    private void showGuideStep(int step) {
        ...
        switch (step) {
            case 1:
                guideContent.setText("Bienvenue dans vos cours inscrits ! Ici vous retrouverez tous les cours auxquels vous êtes inscrit.");
