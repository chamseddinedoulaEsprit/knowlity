...
public class ModifierQuizQuestionController {
    ...
    private QuizQuestion questionToModify;
    ...
    public void setQuestionToModify(QuizQuestion question) {
        if (question != null) {
            ...
            ordreField.setText(String.valueOf(question.getOrdre()));
    ...
    private void saveQuestion() {
        try {
            ...
            questionToModify.setType(type);
            questionToModify.setPoints(points);
            questionToModify.setTexte(texte);
            questionToModify.setOrdre(ordre);
            questionToModify.setQuiz(quiz);

            serviceQuizQuestion.update(questionToModify);

            showMessage("Question modifiée avec succès !");
            closeWindow();
        } catch (Exception e) {
            showErrorMessage("Erreur lors de la modification de la question : " + e.getMessage());
        }
    }
