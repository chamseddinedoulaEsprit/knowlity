...
import tn.knowlity.service.EmailSender;
import tn.knowlity.service.userService;
import tn.knowlity.tools.SessionMMailing;
...
animateBackgroundCircles();
    ...
    public void  sendverificationcode() throws SQLException, IOException {
     String  adressemail =email.getText();
        ...
        if(user != null) {
            ...
            showError("Adresse Email n'existe pas",emailErrorLabel);
        }
    }
   ...
   if(passwordInput.equals(confirmpasswordInput) && !passwordInput.equals("") && passwordInput!=null){
      ...
      this.pagelogin();
       ...
       showError("Verifiez le mot de pass",errorMessageLabel);
    ...
    public void testerverificationcode() throws SQLException, IOException {
        ...
        if (verifcodeinput.equals(verifcode1)) {
          ...
          this.pageresetmotdepass();
            ...
            showError("Code Incorrecte",verificationCodeErrorLabel);
    ...
    public void pagecode() throws IOException {
        ...
        navbarController.changeScene("/User/verificationcode.fxml", currentStage);
    }
    public void pageresetmotdepass() throws IOException {

        Stage currentStage = (Stage) circle1.getScene().getWindow();
        navbarController.changeScene("/User/changePassword.fxml", currentStage);
    }
